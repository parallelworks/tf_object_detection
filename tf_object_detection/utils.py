...
def display_images(inp):
    display_image(inp[0], path = inp[1])
...
def download_and_resize_image(url, new_width=256, new_height=256, display=False):
    ...
    pil_image_rgb = resize_image(image_data, new_width = new_width, new_height = new_height)
